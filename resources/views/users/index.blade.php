            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between mb-4">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">Users</h2>

                        <a href="{{ route('users.create') }}" class="bg-green-500 text-white px-4 py-2 rounded">
                            Add
                        </a>
                        ...
                        <tbody>
                            ...
                            @foreach ($users as $u)
                                <tr
                                    ...
                                    <td class=" border  p-2" style="text-align: center">{{ $u->id }}</td>
                                    ...
                                    <td class=" border  p-2">
                                        {{ $u->groupUser->group_user_name ?? '' }}
                                    </td>
                                    <td class=" border  p-2">
                                        @if ($u->is_enable == '1')
                                            <span class="text-green-500">Enable</span>
                                        @else
                                            <span class="text-red-500">Disable</span>
                                        @endif
